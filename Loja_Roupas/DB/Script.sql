...
/*CLIENTE NULO*/
INSERT INTO `clientes` (`id_cliente`, `nome`, `data_Nascimento`, `CPF`, `Cidade`, `Celular1`, `endereco`, `Num_Casa`, `telefone`, `celular2`, `Observacao`, `Data_Cadastro`) VALUES (NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
ALTER TABLE LISTA_PRODUTOS ADD CONSTRAINT FK_LISTA_PRODUTOS_VENDAS  @@@ Error
FOREIGN KEY (VENDA_ID) REFERENCES VENDAS(ID_VENDA); */ 
...
//GANHO ESTIMADO
	SELECT SUM(VALOR_VENDA * QUANTIDADE) FROM PRODUTOS WHERE DATA_CADASTRO BETWEEN '2020-02-04' AND '2020-03-04'
	AND QUANTIDADE > 0;

//VENDA BRUTA
	SELECT SUM(TOTAL) FROM VENDAS WHERE DATA_VENDA BETWEEN '2020-02-02' AND '2020-03-05' AND FORMA_PAGAMENTO = 'A VISTA';


//COMPRA DE PRODUTOS
	SELECT SUM(VALOR_COMPRA * QUANTIDADE) FROM PRODUTOS WHERE DATA_CADASTRO BETWEEN '2020-02-04' AND '2020-03-04';

//CUSTOS ADICIONAIS
	SELECT SUM(VALOR) FROM CONTAS WHERE DATA_EMISSAO BETWEEN '2020-02-04' AND '2020-03-05' AND STATUS = 'PAGO';
...
//TOTAL DE GASTOS
		//SOMA-SE O VALOR DE COMPRA DE PRODUTOS E DE CUSTOS ADICIONAIS;

//GANHO LÍQUIDO
		//SUBTRAIR O VALOR DE VENDA BRUTA PELO TOTAL DE GASTOS; 

//PEÇAS MASCULINAS
	SELECT COUNT(L.id_lista_produtos) FROM LISTA_PRODUTOS L
	INNER JOIN VENDAS V 
	ON V.ID_VENDA = L.VENDA_ID
	INNER JOIN PRODUTOS P 
	ON P.ID_PRODUTO = L.PRODUTO_ID
	WHERE V.DATA_VENDA BETWEEN '2020-02-02' AND '2020-03-05' AND P.GENERO = 'MASCULINO';
...
//PEÇAS FEMININAS
	...
	INNER JOIN PRODUTOS P 
	ON P.ID_PRODUTO = L.PRODUTO_ID
	WHERE V.DATA_VENDA BETWEEN '2020-02-02' AND '2020-03-05' AND P.GENERO = 'FEMININO';
...
//PEÇAS UNISSEX
	...
	INNER JOIN PRODUTOS P 
	ON P.ID_PRODUTO = L.PRODUTO_ID
	WHERE V.DATA_VENDA BETWEEN '2020-02-02' AND '2020-03-05' AND P.GENERO = 'UNISSEX';
...
//PEÇAS INFANTIS
	...
	INNER JOIN PRODUTOS P 
	ON P.ID_PRODUTO = L.PRODUTO_ID
	WHERE V.DATA_VENDA BETWEEN '2020-02-02' AND '2020-03-05' AND P.CATEGORIA = 'INFANTIL';
...
//PEÇAS ADULTOS
	...
	INNER JOIN PRODUTOS P 
	ON P.ID_PRODUTO = L.PRODUTO_ID
	WHERE V.DATA_VENDA BETWEEN '2020-02-02' AND '2020-03-05' AND P.CATEGORIA = 'ADULTO';

//PROMISSORIAS GERADAS
	SELECT COUNT(*) FROM PROMISSORIAS WHERE DATA_EMISSAO BETWEEN '2020-02-02' AND '2020-03-05';

//CONTAS A RECEBER
	SELECT SUM(VALOR) FROM PROMISSORIAS WHERE DATA_EMISSAO BETWEEN '2020-02-04' AND '2020-03-05' AND STATUS = 'PENDENTE';

//CONTAS A PAGAR
SELECT SUM(VALOR) FROM CONTAS WHERE DATA_EMISSAO BETWEEN '2020-02-04' AND '2020-03-05' AND STATUS = 'PENDENTE';
